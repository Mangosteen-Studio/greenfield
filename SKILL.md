---
name: accounthack
description: Structured AI account research skill for greenfield enterprise prospecting. Use when the user wants to research a target account, identify urgency signals and warm paths, map stakeholders, and draft persona-specific outreach before outbound.
---
...
Use this skill when a user needs to research a single target account before outbound, identify urgency signals, map the right people, find warm paths, and turn the research into usable first outreach plus an account plan.
